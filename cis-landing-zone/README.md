# CIS Landing Zone - Fortinet FortiGate
...
Since you are using **CIS landing zone** to create your environment, you will see different subnet name but to clear any confusion you can follow table which reflect subnet names as per FortiGate Firewall standards: 
